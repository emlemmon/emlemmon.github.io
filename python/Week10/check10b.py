...
def sort(numbers):
    ...
    """
    for indexNum in range(1, len(numbers)):
        currentVal = numbers[indexNum]
        currentPosition = indexNum

        while currentPosition > 0 and numbers[currentPosition - 1] > currentVal:
            numbers[currentPosition] = numbers[currentPosition -1]
            currentPosition = currentPosition - 1

        numbers[currentPosition] = currentVal
